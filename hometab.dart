...
class homeTab extends StatefulWidget {
  ...
  const homeTab({super.key, required this.user, required this.position});
...
class _homeTabState extends State<homeTab> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
        ...
        child: Scaffold(
                              ...
                              children: [
                                Flexible(
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    fit: BoxFit.cover,
                                    imageUrl:
                                        "${Config.SERVER}assets/productimages/$productlist[index].'hsid'}.png",
          ...
          drawer: MainMenuWidget(user: widget.user, position: widget.position,),
        ));
  }
  ...
  void _loadBuyerProducts() {
    ...
    http
        .get(
      Uri.parse(
          "${Config.SERVER}/php/loadbuyer_products.php"),
    )
        .then((response) {
      if (response.statusCode == 200) {
        ...
        if (jsondata['status'] == 'success') {
          ...
          if (extractdata['products'].forEach((v) {
  ...
  _prodDetails(int index) {
    Product product = Product(
      ...
      hsqty: productlist[index].hsqty,
      hsstate: productlist[index].hsstate,
      hsloc: productlist[index].hsloc,
    ...
    showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            title: Text(
              "Delete ${truncateString(
                productlist[index].hsname.toString(),
              )}",
              style: TextStyle(),
            ),
